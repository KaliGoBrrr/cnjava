package Servlets;
import static Servlets.DBUtils.deleteKhachhang;
...
@WebServlet("/KhachHangxoa")
public class KhachHangxoa extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            DBUtils.deleteKhachhang(conn, ma_khach_hang);
